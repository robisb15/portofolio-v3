...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 bg-slate-50 dark:bg-slate-900 border-y border-slate-200 dark:border-slate-800 rounded-3xl mx-4 md:mx-12 my-12 relative overflow-hidden transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex flex-wrap gap-8 pt-4">
              {stats.map((stat, idx) => (
                <div key={idx} className="flex flex-col">
                  ...
                  <span className="text-sm font-medium text-slate-500 dark:text-slate-300 uppercase tracking-wider">{stat.label}</span>
                </div>
              ))}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="p-6 rounded-2xl flex flex-col justify-center border-2 border-dashed border-slate-300 dark:border-slate-700 bg-transparent text-center items-center">
               ...
               <p className="text-sm font-medium text-slate-500 dark:text-slate-300">Dedicated to Excellence</p>
            </div>
          </motion.div>
        </div>
      </div>
